...
export const projects: Project[] = [
  {
    ...
    sections: [
      ...
      { title: "What I learned", body: ["This project was a crash course in Arduino and mechatronics. I had robotics experience from high school, but there was no guidelines here and I was responsible for every part of the project, and got to design and fabricate every part myself. This was also an excellent opportunity for me to further strengthen my SOLIDWORKS, DFM, and general design skills. Additionally, the project made system-level tradeoffs much more concrete. Reduction ratio, motor sizing, weight distribution, material properties, backlash, electronics, heat, and software behavior all affect one another; improving one area can easily expose a limitation somewhere else, and so it is incredibly important to understand how everything interacts with eachother to make good engineering decisions."] },
