...
function Home() {
  return <main id="top"><Header />
    <section className="intro"><div className="intro-copy"><p className="label">Mechanical Engineering · University of Vermont · Class of 2028</p><h1>Isaiah Kol</h1><p className="intro-line">Junior mechanical engineering student with a background in competitive robotics, experience in lab leadership, and strong interests in <strong>aerospace, manufacturing, and robotics.</strong></p><div className="intro-actions"><a className="project-jump" href="#projects">View projects</a><a className="linkedin-button" href="https://www.linkedin.com/in/isaiahkol" target="_blank" rel="noreferrer"><span aria-hidden="true">in</span> LinkedIn</a></div></div><div className="portrait-wrap"><img className="portrait" src="/media/headshot.jpg" alt="Isaiah Kol" /><a className="credential-badge" href="https://www.credly.com/badges/169bc3c7-e2e1-45af-888c-20b8ebb2618e/public_url" target="_blank" rel="noreferrer" aria-label="Verify Isaiah Kol’s Certified SOLIDWORKS Associate credential on Credly"><img src="/media/cswa-badge.svg" alt="Certified SOLIDWORKS Associate badge" /></a></div></section>
