...
const featured = [
  ...
  { title: "Cycloidal Drive", kicker: "21:1 reduction · Gearbox design", active: true, image: "/media/cycloidal-drive/2cycloidv3.jpg", href: "/projects/cycloidal-drive", description: "Compact, low-backlash gearboxes designed from scratch for every joint of the robot arm.", tags: ["Equation-driven CAD", "FDM", "Prototyping"] },
